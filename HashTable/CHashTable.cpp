...
*			o(*￣▽￣*)o	**
****************************************************************************************
*			Project Name：哈希表 -- 方法实现
*
*			FileName：CHashTable.cpp
*
*			Programmer：ileemi
*
...
/*=======================================================
*	bool CHashTable::Insert(int nKey, double dblVal) -- 根据关键字 nKey 插入数据值 dblVal
*
*	参数：int nKey -- 关键字，double dblVal -- 值
*
*	返回值：插入成功返回true
*
*	警告：无
...
/*=======================================================
*	bool CHashTable::Remove(int nKey) -- 根据关键字 nKey 删除在链表中对应的结点数据
*
*	参数：int nKey -- 关键字
*
...
/*=======================================================
*	bool CHashTable::Find(int nKey) const -- 通过关键字 nKey  在表中查找是存在
*
*	参数：int nKey -- 关键字
*
