...
private:
	...
	{
		tagNode(T val, int nNodeHeight, tagNode* pParent, tagNode* pLeft, tagNode* pRight) :
			m_val(val),
...
/*=======================================================
*	bool CAVLTree<T>::Insert(T val) -- 插入数据
*
*	参数：val -- 插入的数据值	
*
...
/*=======================================================
*	bool CAVLTree<T>::Remove(T val) -- 删除指定的数据
*
*	参数：val -- 删除的数据值	
*
...
/*=======================================================
*	bool CAVLTree<T>::Updata(T valSrc, T valDst) -- 修改数据
*
...
/*=======================================================
*	bool CAVLTree<T>::Find(T val) -- 查找指定的数据值
*
*	参数：val -- 查找的数据值	
*
...
/*=======================================================
*	void CAVLTree<T>::MLRUseLoop() -- 前序遍历（非递归）
*
*	参数：无
*
*	返回值：无
...
/*=======================================================
*	void CAVLTree<T>::LMRUseLoop() -- 中序遍历（非递归）
*
*	参数：无
*
*	返回值：无
...
/*=======================================================
*	void CAVLTree<T>::LRMUseLoop() -- 后序遍历（非递归）
*
*	参数：无
*
*	返回值：无
...
/*=======================================================
*	void CAVLTree<T>::Destroy(PNODE pNode) -- 使用递归清除树中有效的所有结点
*
...
/*=======================================================
*	PNODE CAVLTree<T>::FindNode(T val)		
...
/*=======================================================
*	void CAVLTree<T>::MLR(PNODE pNode) -- 递归 前序 遍历
*
...
/*=======================================================
*	void CAVLTree<T>::LMR(PNODE pNode) -- 递归 中序 遍历
*
*	参数：PNODE pNode -- 开始遍历的根结点
*
*	返回值：无
...
/*=======================================================
*	void CAVLTree<T>::LRM(PNODE pNode) -- 递归 后序 遍历
*
*	参数：PNODE pNode -- 开始遍历的根结点
*
*	返回值：无
...
/*=======================================================
*	int CAVLTree<T>::CalcNodeHeight(PNODE pNode) -- 计算 传入结点的高度
*
...
/*=======================================================
*	int CAVLTree<T>::GetNodeHeight(PNODE pNode) const -- 获取结点高度
*
...
/*=======================================================
*	void CAVLTree<T>::RotateLeft(PNODE pNode) --  左单旋，调整树的平衡
*
...
/*=======================================================
*	void CAVLTree<T>::RotateRight(PNODE pNode) --  右单旋，调整树的平衡	
*
*	参数：PNODE pNode -- 需要进行旋转的结点
*
*	返回值：无
