...
*/
template<typename T>
bool CList<T>::Insert(iterator pNode, T val)
{
...
========================================================*/
template<typename T>
bool CList<T>::SetVal(iterator pNode, T val)
{
